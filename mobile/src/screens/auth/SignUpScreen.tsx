        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity 
              style={[
                styles.button, 
                (isLoading || !passwordStrength?.isValid || password !== confirmPassword || !email || !fullName) && styles.buttonDisabled
              ]}
              onPress={handleSignUp}
              disabled={isLoading || !passwordStrength?.isValid || password !== confirmPassword || !email || !fullName}
            >
              {isLoading ? (
